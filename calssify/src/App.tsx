...
// // Dummy components--replace or import as needed
// const NavBar = ({ logoSrc }: { logoSrc: string }) => (
//   <div className="bg-blue-700 py-3 px-8 mb-4 flex items-center">
//     <img src={logoSrc} alt="Logo" className="h-10" />
//   </div>
// );
// // Replace "/images/IQ.png" with your logo path or use a static string
...
//   // Separate Document PII state/results
...
//   const toggleMetadata = (index: number, type: "default" | "doc-pii" = "default") => {
//     if (type === "default") {
//       setResults((prev) =>
//         prev.map((res, i) =>
...
//   // For ML/metadata/DB scan as before
...
//     if (files.length === 0 || docPiiLoading) return;
...
//         // Only latest results kept (latest scan replaces table)
...
//               className={`px-4 py-2 rounded ${scanContext === "document" ? "bg-blue-600 text-white" : "bg-gray-300"}`}
//             >
//               Image Scan
//             </button>
//             <button
//               onClick={() => setScanContext("db")}
//               className={`px-4 py-2 rounded ${scanContext === "db" ? "bg-blue-600 text-white" : "bg-gray-300"}`}
//             >
//               DB Scan
//             </button>
//           </div>
...
//                 disabled={docPiiLoading || files.length === 0}
//               >
//                 Document PII Scan
//               </button>
//             </div>
...
//               <div className="bg-blue-600 h-full transition-all duration-200 progress-bar" style={{ width: `${progress}%` }} />
//             </div>
//           )}
//           {results.length > 0 && (
//             <div className="overflow-x-auto mt-6">
//               <h2 className="text-xl font-semibold mb-2 text-blue-800">Scan Results</h2>
...
//                           <button
//                             onClick={() => toggleMetadata(idx, "default")}
...
//             </div>
//           )}
//           {/* Document PII Results Section */}
//           {(docPiiLoading || documentPiiResults.length > 0) && (
//             <div className="overflow-x-auto mt-8">
//               <h2 className="text-xl font-semibold mb-2 text-purple-800">Document PII Scan Results</h2>
//               {docPiiLoading && (
...
//                 </div>
//               )}
//               {documentPiiResults.length === 0 && !docPiiLoading && (
...
//                       // Extract all PII types found for display
//                       const piiTypeNames = res.pii_types ? Object.keys(res.pii_types).filter(k => res.pii_types[k]?.length) : [];
//                       return (
...
//                             <td className="px-4 py-3">
//                               {res.pii_found ? <span className="text-green-700 font-bold">Yes</span> : <span className="text-gray-400">No</span>}
//                             </td>
//                             <td className="px-4 py-3">
//                               {piiTypeNames.length > 0
//                                 ? piiTypeNames.join(", ")
//                                 : "-"}
//                             </td>
//                             <td className="px-4 py-3">
//                               <button
//                                 onClick={() => toggleMetadata(idx, "doc-pii")}
//                                 className="text-blue-600 underline"
//                               >
//                                 {res.showMetadata ? "Hide" : "Show"} Details
//                               </button>
...
// Dummy navbar & logo -- swap with your own if necessary
const NavBar = ({ logoSrc }: { logoSrc: string }) => (
  <div className="bg-blue-700 py-3 px-8 mb-4 flex items-center">
    <img src={logoSrc} alt="Logo" className="h-10" />
  </div>
